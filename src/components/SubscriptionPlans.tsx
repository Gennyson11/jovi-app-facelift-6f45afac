  ...
  return (
    <div className="w-full">
      <div className="text-center mb-12">
        ...
        <h3 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-primary mt-2">
          PLANO PREMIUM
        </h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        ...
        {/* Quarterly Plan */}
        <div
          className="relative p-6 md:p-8 rounded-3xl bg-card/40 border-2 border-primary/40 transition-all duration-500 group hover:scale-[1.02] md:hover:scale-105 hover:border-primary/70"
          style={{
            boxShadow: '0 0 100px -20px hsl(var(--primary) / 0.6), inset 0 1px 0 0 hsl(var(--primary) / 0.2)'
          }}>
          <div className="flex justify-center mb-4 md:mb-6">
            <span className="px-4 md:px-6 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-display font-bold bg-accent text-accent-foreground shadow-lg shadow-accent/30">
              MELHOR CUSTO
            </span>
          </div>
          <div className="text-center">
            ...
            <p className="text-primary text-sm md:text-base font-semibold">Apenas R$22,33/mês</p>
          </div>
          <ul className="mt-6 md:mt-8 space-y-3 md:space-y-4">
            {benefits.map((benefit) => (
              <li key={benefit} className="flex items-center gap-2 md:gap-3 text-xs md:text-sm lg:text-base text-muted-foreground">
