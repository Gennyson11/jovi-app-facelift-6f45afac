...
const aiTools = [
  "VEO 3.1 ULTRA", "GEMINI PRO", "HEYGEN PRO", "DIGEN ULTRA MAX", "PERPLEXITY PRO",
  "CANVA PRO", "ADS PARO", "LEONARDO AI", "PHOTOROOM MAX",
  "GAMMA APP PRO", "CSVGEN ILIMITADO", "CHATGPT", "SORA",
  "SUPER GROK", "DREAM FACE PRO", "IDEOGRAM PLUS", "FREEPIK PREMIUM+"
];


const streamingTools = [
  "JOVIFLIX FILMES & SÉRIES", "CINDIE TV", "DISNEY+", "PARAMOUNT+", "PRIME VIDEO"
];
