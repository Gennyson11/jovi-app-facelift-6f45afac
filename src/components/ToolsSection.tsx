...
const aiTools = [
  ...
  "SUPER GROK", "DREAM FACE PRO", "IDEOGRAM PLUS", "FREEPIK PREMIUM+", "ENVATO ELEMENTS", "DESIGNRR", "CAPTIONS AI", "CRAMLY AI", "DEEPSEEK", "SUNO AI", "CAPCUT PRO", "SEEDANCE 2.0", "KLING 3.0 PRO"
];
