                ...
                {count === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-1">
                    {cat.tutorials.map((t) => (
                      <div
                        key={t.id}
                        className="group overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-b from-card/70 to-card/30 hover:border-emerald-500/40 transition-colors flex flex-col max-w-xl"
                      >
                          ...
                          {playing[t.id] ? (
                            ...
                            >
                              ...
                              <div className="absolute inset-0 flex items-center justify-center">
                                <div className="w-12 h-12 rounded-full bg-background/70 backdrop-blur border border-white/20 flex items-center justify-center group-hover:bg-emerald-500/80 group-hover:border-emerald-300 transition-colors">
                        ...
                        <div className="p-4 flex flex-col gap-2.5 flex-1">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {t.tags.map((tag, i) => (
                                <span
                                  ...
                                  className={
                                    tag.variant === 'primary'
                                      ? 'inline-flex items-center rounded-full px-2.5 py-1 text-[11px] font-bold tracking-wide bg-emerald-500/15 text-emerald-400 border border-emerald-500/40'
                                      : 'inline-flex items-center rounded-full px-2.5 py-1 text-[11px] font-semibold tracking-wide bg-background/50 text-muted-foreground border border-border/70'
                                  }
                                >
                                  {tag.label}
                                </span>
                          ...
                          <div className="mt-auto pt-2 flex items-center justify-between gap-2">
                            ...
                            <Button
                              size="sm"
                              onClick={() => setPlaying((p) => ({ ...p, [t.id]: true }))}
                              className="h-9 px-4 text-sm rounded-full bg-emerald-500 hover:bg-emerald-400 text-background font-semibold"
                            >
                              Assistir aqui
                            </Button>
                          </div>
